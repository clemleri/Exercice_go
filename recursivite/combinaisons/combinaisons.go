...
En le faisant, vous remarquerez que vous construisez trop de combinaisons (il y a des doublons). 
Pour éviter cela, vous pouvez utiliser une borne indiquant la valeur maximum à considérer (qui sera donc le minimum entre n et cette borne),
qui sera passée dans vos appels récursifs.
